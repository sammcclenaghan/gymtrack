...
class WorkoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workout" do
    assert_difference("Workout.count") do
      post workouts_url, params: { workout: { name: @workout.name, starts_at: @workout.starts_at } }
    end
  ...
  test "should update workout" do
    patch workout_url(@workout), params: { workout: { name: @workout.name, starts_at: @workout.starts_at } }
