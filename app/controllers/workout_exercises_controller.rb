class WorkoutExercisesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @workout_exercise.save
        format.html { redirect_to workout_url(@workout_exercise.workout), notice: "Exercise was successfully added." }
  ...
  def update
    respond_to do |format|
      if @workout_exercise.update(workout_exercise_params)
        format.html { redirect_to workout_url(@workout_exercise), notice: "Exercise was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to workout_url(@workout_exercise.workout), notice: "Exercise was successfully destroyed." }  
    end
  end
